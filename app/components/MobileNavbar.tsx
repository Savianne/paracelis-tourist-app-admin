...
const NavBarMobileFC: React.FC<IStyledFC> = ({className}) => {
    ...
    return(
        <div className={className}>
            ...
            <BtnExpand open={open} onClick={() => setOpen(!open)}>
                <span className="btn">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path d="M182.6 470.6c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-9.2-9.2-11.9-22.9-6.9-34.9s16.6-19.8 29.6-19.8l256 0c12.9 0 24.6 7.8 29.6 19.8s2.2 25.7-6.9 34.9l-128 128z"/></svg>
                </span>
            </BtnExpand>
        </div>
    )
...
const BtnExpand = styled.div<{open: boolean}>`
    && {
        // position: absolute;
        // bottom: 0;
        // left: 0;
        ...
        > .btn {
            ...
            align-items: center;
            justify-content: center;
            rotate: ${(p) => p.open? "180deg" : "0"};
            transition: rotate 300px;
...
`
const NavBarMobile = styled(NavBarMobileFC)`
    position: fixed;
    top: 0;
    left: 0;
    display: flex;
