...
interface IGallery extends IStyledFC {
    ...
    src: string[];
    onDeletedPhoto: () => void;
    onChangedDp: (i:string) => void
} 

const PlaceGalleryFC:React.FC<IGallery> = ({className, src, onDeletedPhoto, placeUID, onChangedDp}) => {
...
const FullScreenViewFC: React.FC<IFullScreenView> = ({className, src, onExitFullScreen, onDelete, onChangeDp}) => {
    const elementRef = React.useRef<HTMLDivElement | null>(null);
    const [showConfirmDelete, setShowConfirmDelete] = React.useState(false);
    const [showConfirmSetAsDp, setShowConfirmSetAsDp] = React.useState(false);
    ...
    return(
        <div className={className} ref={elementRef}>
            <div className="action-toogle-container">
                ...
                <div className="action-btn" onClick={() => setShowConfirmSetAsDp(true)}>
...

            {
                ...
                <div className="confirm-overlay">
                    <div className="confirm-change">
                        ...
                        <div className="actions">
                            <span className="confirm" onClick={onChangeDp}>Okay</span>
                            <span className="cancel" onClick={() => setShowConfirmSetAsDp(false)}>Cancel</span>
                        </div>
                    </div>
                </div> : ""
            }
